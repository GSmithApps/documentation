...
The `patched` function behaves as described in the following example. And after that, there is an example of what not to do.
...
And this is an anti-example of what not to do:
